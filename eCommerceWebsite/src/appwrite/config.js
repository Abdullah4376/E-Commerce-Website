...
export class Service{
    ...
    async addProduct({title, slug, content, featuredImage, status, UserID, /*brand, price, quantity */}){
        try {
    ...
    async updateProduct(slug, {title, content, featuredImage, status, /* price, quantity*/}){
        try {
